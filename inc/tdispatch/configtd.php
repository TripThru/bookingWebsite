...
class ConfigTD {
	...
	private static $fleetApiKey	= '1f4060f0684ddc4752ded4ca8233bd2b';
	private static $apiClientId	= 'XU3PSNDBWP@tdispatch.com';
	private static $apiSecret	= 'yBuFN4Pmfxfm5kQ3YKvCIa8NkV1Psrhc';

	private static $homeUrl		= 'http://localhost/TripThruWeb/';	 // URL of your website this scripts are hosted on, i.e. https://yourwebsite.com/
